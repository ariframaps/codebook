...
export const DashBoardEmpty = () => {
    return (
        <div className="relative p-4 w-full max-w-3xl p-4 h-full md:h-auto">
            <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-10 shadow-lg my-20">
                ...
                <p className="my-10 text-lg font-semibold text-gray-900 dark:text-white">Oops! Your don't have any order yet, start shopping now!</p>
