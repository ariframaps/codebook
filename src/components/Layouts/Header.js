...
export const Header = () => {
    ...
    return (
        <header>
            <nav nav className="bg-white dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600" >
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="items-center justify-between text-start w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
